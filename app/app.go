...
func New(
	...
	app.JerrychainKeeper = *jerrychainmodulekeeper.NewKeeper(
		appCodec,
		keys[jerrychainmoduletypes.StoreKey],
		keys[jerrychainmoduletypes.MemStoreKey],
		app.GetSubspace(jerrychainmoduletypes.ModuleName),
	)
